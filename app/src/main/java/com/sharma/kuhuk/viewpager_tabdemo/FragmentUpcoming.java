...
public class FragmentUpcoming extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView =  inflater.inflate(R.layout.fragment_fragment_upcoming, container, false);
        ...
        recyclerView = rootView.findViewById(R.id.rvUpcoming);
        ...
        adapter = new AdapterUpcoming(stringArrayList);
        recyclerView.setAdapter(adapter);

        mvOnClickListener = new FragmentUpcoming.MVUOnClickListener(getActivity());
    ...
    private static class MVUOnClickListener implements View.OnClickListener {
        private final Context context;

        private MVUOnClickListener(Context context) {
